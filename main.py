...
title_label = Label(
    text="Timer", foreground=GREEN, font=(FONT_NAME, 24, "bold "), bg=YELLOW
)
...
time_text = canvas.create_text(
    101, 145, text="00:00", fill="white", font=(FONT_NAME, 24, "bold")
)
...
check_marks = Label(text="✔", bg=YELLOW, foreground=GREEN)
